...
public class EnemyScript7 : MonoBehaviour
{
    ...
    private IEnumerator ToEnemyAttack()
    {
        ...
        if (enemy != null)
            enemy.GetComponent<PlayerScript7>().playerHP -= attack; //Ç±Ç±Ç≈GetComponentÇµÇƒÇÈÅB
        ToEnemyAttacking = true;
    }
    ...
    private IEnumerator ToCastleAttack()
    {
        ...
        cenemy.GetComponent<CastleScript7>().HP -= attack;
        ToCastleAttacking = true;
    }
}
