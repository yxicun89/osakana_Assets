...
public class EnemyScript8 : MonoBehaviour
{
    ...
    private IEnumerator ToEnemyAttack()
    {
        ...
        if (enemy != null)
            enemy.GetComponent<PlayerScript8>().playerHP -= attack; //Ç±Ç±Ç≈GetComponentÇµÇƒÇÈÅB
        ToEnemyAttacking = true;
    }
    ...
    private IEnumerator ToCastleAttack()
    {
        ...
        cenemy.GetComponent<CastleScript8>().HP -= attack;
        ToCastleAttacking = true;
    }
}
