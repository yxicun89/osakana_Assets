...
public class EnemyScript30 : MonoBehaviour
{
    ...
    private IEnumerator ToEnemyAttack()
    {
        ...
        if (enemy != null)
        {
            enemy.GetComponent<PlayerScript30>().playerHP -= attack; //Ç±Ç±Ç≈GetComponentÇµÇƒÇÈÅB
        }
        ToEnemyAttacking = true;
    }
    ...
    private IEnumerator ToCastleAttack()
    {
        ...
        cenemy.GetComponent<CastleScript30>().HP -= attack;
        ToCastleAttacking = true;
    }
}
