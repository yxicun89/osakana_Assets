...
public class EnemyScript9 : MonoBehaviour
{
    ...
    private IEnumerator ToEnemyAttack()
    {
        ...
        if (enemy != null)
            enemy.GetComponent<PlayerScript9>().playerHP -= attack; //Ç±Ç±Ç≈GetComponentÇµÇƒÇÈÅB
        ToEnemyAttacking = true;
    }
    ...
    private IEnumerator ToCastleAttack()
    {
        ...
        cenemy.GetComponent<CastleScript9>().HP -= attack;
        ToCastleAttacking = true;
    }
}
